...
function guardarPregunta (Pregunta){ 
    myDb.executeUpdateWithParams("INSERT INTO PlantillaPreguntas (id, textoPregunta, tipo, puntos, nivel) VALUES (?, ?, ?, ?, ?)", 
        [pPregunta.getIdPregunta(),pPregunta.getTextoPreg(), pPregunta.getTipo(), pPregunta.getPunto(), pPregunta.getNivel()]);
}
...
$(document).ready(function() {
    ...
    myDb.executeUpdate("CREATE TABLE IF NOT EXISTS PlantillaPreguntas (id int unique, id_prueba int, pregunta varchar(60), tipo varchar(20),resp1 varchar(50),resp2 varchar(50),resp3 varchar(50),resp4 varchar(50),opcCorrect varchar(10), puntos varchar(10), nivel varchar(6))");
